...
@section('main-content')
    ...
    <section class="shop checkout section">
        <div class="container">
                <form class="form" method="POST" onsubmit="return validateForm()" action="{{route('cart.order')}}">
                    @csrf
                    <div class="row"> 
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="order-details">
                                ...
                                <div class="single-widget get-button">
                                    <div class="content">
                                        <div class="button">
                                            <button type="submit" class="btn" onclick="validateEmail(document.form1.email)">Đặt hàng</button>
                                        </div>
                                    </div>
                                </div>
                                <!--/ End Button Widget -->
...
@push('scripts')
    ...
    <script>
        function validateForm() {
            ...
            if (!formValid) alert("Vui lòng chọn phương thức thanh toán!");
            return formValid;
        }
    </script>
    <script> 
