								...
								@else 
										<tr>
											<td class="text-center">
												Không có sản phẩm nào. <a href="{{route('product-grids')}}" style="color:blue;">Tiếp tục mua sắm</a>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Giảm<span>${{number_format(Session::get('coupon')['value'],2)}}</span></li>
										@endif
										@php
