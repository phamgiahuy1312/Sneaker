...
@endsection
@section('title','H-Sneaker || Chi tiết sản phẩm')
								...
								<div class="row">
											...
											<div class="flexslider-thumbnails">
												<ul class="slides">
													...
													@foreach($photo as $data)
														<li data-thumb="{{$data}}" rel="adjustX:10, adjustY:" class="xzoom-gallery">
															<img src="{{$data}}" alt="{{$data}}" class="xzoom" xoriginal="{{$data}}">
														</li>
													@endforeach
												</ul>
											</div>
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											@if($product_detail->size)
												<div class="size mt-4">
													...
													<ul>
														...
														<input type="radio" name="size" class="one block-size" id="" value="{{$size}}">
											...
											@endif
											<!--/ End Size -->
											<h4 class="stock-product">Sản phẩm trong kho : @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span>  @endif</h4>
											<!-- Product Buy -->
											<div class="product-buy">
												...
												{{-- <p class="availability" style="margin: 10px;">Sản phẩm trong kho : @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span>  @endif</p> --}}
														...
														<div class="row">
															<div class="col-12">
																...
																<div class="comment-review">
																	...
																	<h4>Xếp hạng<span class="text-danger">*</span></h4>
