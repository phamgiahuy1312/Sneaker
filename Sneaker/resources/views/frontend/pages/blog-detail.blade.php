...
@section('title','H-Sneaker || Tin Tức')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Tin Tức<i class="ti-arrow-right"></i></a></li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>{{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Bình luận ({{$post->allComments->count()}})</a></span>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Gửi</span><span class="comment_btn reply" style="display: none;">Trả lời bình luận</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    <h3 class="comment-title">Danh sách bình luận ({{$post->allComments->count()}})</h3>
                                    <!-- Single Comment -->
                    ...
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Theo dõi để nhận được tin tức mới nhất.</h4>
