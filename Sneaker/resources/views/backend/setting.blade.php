...
<div class="card">
    <h5 class="card-header">Thiết lập</h5>
    <div class="card-body">
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="short_des" class="col-form-label">Mô tả<span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="inputPhoto" class="col-form-label">Ảnh giới thiệu <span class="text-danger">*</span></label>
          <div class="input-group">
              <span class="input-group-btn">
...
<script>
    ...
    $(document).ready(function() {
      $('#description').summernote({
        placeholder: "Viết miêu tả chi chiết",
          tabsize: 2,
          height: 150
      });
    });
