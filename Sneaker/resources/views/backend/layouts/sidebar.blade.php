<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      ...
      <div id="postCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{route('post.index')}}">Danh sách tin tức</a>
          <a class="collapse-item" href="{{route('post.create')}}">Thêm tin tức</a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="tagCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Tùy chọn Tags:</h6>
            <a class="collapse-item" href="{{route('post-tag.index')}}">Danh sách Tags</a>
